...
import InfoCard from "./overview/o-info-cards";
import YearlyTrend from "./overview/o-yealy-trend";
import RecentMonths from "./overview/o-recent-months";
import TotalBarChart from "./overview/o-total-piecharts";
...
export default function Overview() {
  ...
  return (
    ...
    >
      ...
      <InfoCard
        type="recentMonths"
        data={overviewData?.recentMonthlyEmissions?.reduce(
